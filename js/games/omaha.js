        ...
        content.innerHTML = `
            <div style="text-align: center;">
                ...
                <div style="margin-top: 30px; padding: 20px; background: rgba(255, 184, 0, 0.1); border-radius: 10px; border: 2px solid #FFB800;">
                    <h3 style="color: #FFB800; margin-bottom: 15px;">👑 Omaha Royale [Quick Simulation]</h3>
                    <p style="font-size: 1.1em; color: #cccccc; margin-bottom: 15px;">⚡ Quick simulation - 4 hole cards variant with instant random outcome</p>
